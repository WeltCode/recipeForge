...
const T = {
  es: {
    ...
    plansFeats: [['Acceso guiado 30 días', 'Cargamos tus recetas contigo', 'Sin tarjeta, sin compromiso'], ['1 usuario · recetas ilimitadas', 'Escandallo y food cost', 'Alérgenos y export A4', 'PDF sin marca'], ['Todo lo de Básico', 'Un restaurante', 'Multiusuario y roles', 'Plantillas personalizables', 'Inventario', 'Carta digital con QR'], ['Todo lo de Premium', 'Varios restaurantes (multi-local)', 'Proveedores y precios de compra', 'Hasta 20 usuarios', 'Roles avanzados']],
  ...
  ca: {
    ...
    plansFeats: [['Accés guiat 30 dies', 'Carreguem les teves receptes amb tu', 'Sense targeta, sense compromís'], ['1 usuari · receptes il·limitades', 'Escandall i food cost', 'Al·lèrgens i exportació A4', 'PDF sense marca'], ['Tot el del Bàsic', 'Un restaurant', 'Multiusuari i rols', 'Plantilles personalitzables', 'Inventari', 'Carta digital amb QR'], ['Tot el del Premium', 'Diversos restaurants (multi-local)', 'Proveïdors i preus de compra', 'Fins a 20 usuaris', 'Rols avançats']],
  ...
  en: {
    ...
    plansFeats: [['Guided 30-day access', 'We load your recipes with you', 'No card, no commitment'], ['1 user · unlimited recipes', 'Costing and food cost', 'Allergens and A4 export', 'Unbranded PDF'], ['Everything in Basic', 'One restaurant', 'Multi-user and roles', 'Custom templates', 'Inventory', 'Digital QR menu'], ['Everything in Premium', 'Multiple restaurants (multi-location)', 'Suppliers and purchase prices', 'Up to 20 users', 'Advanced roles']],
      ...
      <div className="relative z-10">
        ...
        <header className="fixed inset-x-0 top-0 z-40 transition-all" style={scrolled || menuOpen ? { background: 'rgba(253,250,245,.72)', backdropFilter: 'blur(16px)', borderBottom: `1px solid ${C.line}` } : {}}>
          <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3.5 md:px-8">
            <a href="#top" aria-label="RecipeForge" onClick={() => setMenuOpen(false)} className="shrink-0"><Logo variant="light" className="text-[20px] sm:text-[26px] md:text-[32px]" /></a>
